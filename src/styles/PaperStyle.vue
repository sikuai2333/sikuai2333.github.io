...
<style scoped>
.page{background:#f7f3eb;color:#3a3a3a;min-height:100vh;padding-top:var(--nav-height);background-image:repeating-linear-gradient(transparent,transparent 31px,#e8e4dc 31px,#e8e4dc 32px)}
...
.board{max-width:1080px;margin:0 auto;padding:0 20px 40px}
.board h2,.checklist h2{font-size:18px;font-weight:700;margin-bottom:16px}
.stickies{display:grid;grid-template-columns:repeat(auto-fill,minmax(240px,1fr));gap:12px}
...
.checklist{max-width:1080px;margin:0 auto;padding:0 20px 40px}
...
.cards{max-width:1080px;margin:0 auto;padding:0 20px 40px;display:grid;grid-template-columns:repeat(auto-fill,minmax(300px,1fr));gap:12px}
...
@media(max-width:768px){.hero .slogan{font-size:clamp(22px,4.5vw,36px)}.stickies{grid-template-columns:repeat(2,1fr)}.cards{grid-template-columns:1fr}}@media(max-width:480px){.stickies{grid-template-columns:1fr}.hero .slogan{font-size:22px}.hero .clock{font-size:24px}}
</style>
